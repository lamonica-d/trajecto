...
save(df_mediane3,"outputs/df_ggplot_mediane")
...
save(df_replicats,"outputs/df_ggplot_replicats")
...
save(df_ic, "outputs/df_ggplot_ic")
...
save(df_coeff_nyct, "outputs/df_ggplot_coeff_nyct")
...
save(df_ggplot_mvt, "outputs/df_ggplot_coeff_mvt")
...
save(df_coeff_enviro, "outputs/df_ggplot_coeff_enviro")
...
save(df_ggplot_intercept, "outputs/df_ggplot_intercept")
...
save(df_heatmap, "outputs/df_ggplot_heatmap_all_values")


#############version avec que les valeurs rencontrees##########################

data1=read.table(file="outputs/data_tous_individus_ready_to_use_v4.csv", header=T, sep=",")[,-1]
load("mtot_list")
is.odd <- function(x) x %% 2 != 0
#choix nyct period var nyct_i aube 8, crep 9, jour 10, nuit 11
nyct_i=10
...
save(df_heatmap2, "outputs/df_ggplot_heatmap_encountered_values")
