...
#pour l'inference on aura besoin de ce fichier + bash + model
#ajouter a la place une fonction qui genere ces trois fichiers
...
inferences <- function (){
  ...
  load(paste0("outputs/data_ind",numpoiss_vect[num_ind],sep="")
  )
